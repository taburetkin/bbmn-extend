...
var index$4 = (function (Base) {
	return Base.extend({
		...
		_normalizeNestedContext: function _normalizeNestedContext(context) {
			var _this2 = this;
			...
			if (context.name == null) context.name = _.uniqueId('nested');
		...
		showAllNestedViews: function showAllNestedViews() {
			...
			_(contexts).each(function (context) {
				return _this3.showNestedView(context);
			});
		},
