...
var RoutesMixin = {
	...
	registerAllRoutes: function registerAllRoutes() {
		...
		var pages = this.getAllChildren({ reverse: true, includeSelf: true });
...
var Token = Backbone$1.Model.extend({
	...
	fetch: function fetch() {
		...
		this._fetching = new Promise(function (resolve) {
			nativeAjax(options).then(function (json) {
