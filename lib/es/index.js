 ...
 */
	getOption: function getOption$$1() {
		...
		return getOption.apply(undefined, [this].concat(toConsumableArray(args)));
	},
	getDocument: function getDocument() {
		return this.$doc || $(document);
	},
	triggerMethod: function triggerMethod$$1() {
		return triggerMethod$1.apply(undefined, [this].concat(Array.prototype.slice.call(arguments)));
	},
	isDestroyed: function isDestroyed() {
		return this._isDestroyed || this._isDestroying;
	},
...
export { index$17 as mixins, index$10 as utils, index$22 as components };
