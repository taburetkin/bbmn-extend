...
function get$2(arg, flag, options) {
...
var index$18 = (function (BaseView) {
...
var index$20 = Object.freeze({
	...
	nestedViews: index$17,
	nextView: index$18,
	destroy: destroy,
	buildViewByKey: index$19
});
...
var EditProperty = (function (Base) {
	var Mixed = mix(Base).with(ControlView, common$1);
	...
	return Mixed.extend({
		...
		getHeaderView: function getHeaderView() {
			var view = buildViewByKey.call(this, 'header', { allowTextView: true });
			if (view) {
				return view;
			}
...
export { index$26 as mixins, index$14 as components, index$16 as utils };
