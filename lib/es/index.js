...
var MergeOptions = ['createView', 'dataFilter', 'dataComparator', 'enableCollection', '$container', 'view', 'modelView', 'modelViewOptions', 'emptyView', 'emptyViewOptions'];
...
var index$5 = (function (BaseView) {
  ...
  */
		...
		getChildrenContainer: function getChildrenContainer() {
			if (this._childrenContainer && this._childrenContainer.jquery) return this._childrenContainer;

			var value = this.getOption('childrenContainer');
...
export { index$9 as mixins, index$15 as utils, index$14 as components };
