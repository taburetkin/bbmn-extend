import Backbone$1, { Collection, Events, Model, Router, View, ajax, history } from 'backbone';
import Mn, { Region, View as View$1 } from 'backbone.marionette';
...
var BaseModel = mix(function BbmnBase() {}).class;

var ctors = [Model, Collection, View, Router, MnObject, BaseModel];
...
var index$3 = (function (Collection$$1) {
...
var convertToBoolean = function convertToBoolean(arg) {
	...
	var other = void 0;
	var options = _.extend({}, defaultOptions$1, opts);
...
var actionable = (function (Base) {
	return Base.extend({
		...
		executeAction: function executeAction(action) {
			this._initializeActionableActions();
			return store.exec.apply(store, [this.actionsStoreName || this.constructor, action, this].concat(Array.prototype.slice.call(arguments)));
		}
...
var Token = Model.extend({
	...
	replaceBackboneAjax: function replaceBackboneAjax() {
		...
		if (!this.hasToken()) Backbone$1.ajax = nativeAjax;else Backbone$1.ajax = function () {
...
var index$6 = (function (CollectionView) {
...
var index$7 = (function (CollectionView) {
	return CollectionView.extend({
...
var customsMixin = (function (Base) {
	return Base.extend({
...
var index$8 = Object.freeze({
	emptyFetch: index$6,
	improvedIndexes: index$7,
	nextCollectionView: nextCollectionView,
	customs: customsMixin
});
...
var config$1 = {
	...
	buildView: function buildView(options, View$$1) {
		...
		options = _.extend({
			textView: this.TextView || View$1,
			closeButtonView: this.CloseButtonView || View$1,
...
var PropertySchema = Schema.extend({
	...
	getLabel: function getLabel(value, hash) {
		var label = this.getDisplay().label;
		return betterResult({ label: label }, 'label', { args: [value, hash] });
	},
	getEditView: function getEditView() {}
});
...
var index$10 = BasePage.extend({
	...
	getPathHash: function getPathHash() {
		...
		if (parent && _.isFunction(parent.getPathHash)) {
			path.unshift.apply(path, toConsumableArray(parent.getPathHash()));
		}
		return path;
	},
...
function start(options) {
	...
	if (history.loadUrl !== historyLoadUrl) history.loadUrl = historyLoadUrl;
...
function check(value) {
	...
	var validateOptions = (_validateOptions = {
		ruleName: rule.name,
		ruleValue: ruleValue
	}, defineProperty(_validateOptions, rule.name, ruleValue), defineProperty(_validateOptions, 'allValues', allValues), defineProperty(_validateOptions, 'message', buildMessage({ value: value, allValues: allValues, ruleValue: ruleValue })), _validateOptions);
...
var index$14 = {
	setRule: function setRule(name, rule) {
...
var customs = {
	...
	_injectCustoms: function _injectCustoms(items, detached) {
		var _this2 = this;
...
_.extend(ViewManager.prototype, Events, borrow, collection, common, customs, models, render, EmptyViewMixin);
...
function get$3(arg, flag, options) {
...
var index$19 = (function (BaseView) {
...
var index$21 = Object.freeze({
	...
	nestedViews: index$18,
	nextView: index$19,
	destroy: destroy,
	buildViewByKey: index$20
});
...
var ControlMixin = (function (Base) {
	return Base.extend({
		...
		_validateControl: function _validateControl(value, options) {
		...
		_validateControlPromise: function _validateControlPromise(value, options) {
			...
			return new Promise(function (resolve, reject) {
				...
				childrenPromise.then(function () {
					...
					var validateResult = validate.call(_this4, value, values, options);
...
var index$23 = (function (Base) {
	...
	return Mixed.extend({
		...
		buildHeaderView: function buildHeaderView(options) {
			return buildViewByKey.call(this, 'header', { allowTextView: true, options: options });
		},
...
var index$27 = Object.freeze({
	...
	collection: index$4,
	view: index$21,
	collectionView: index$8,
	controls: index$26
});

export { index$27 as mixins, index$15 as components, index$17 as utils };
