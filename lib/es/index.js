...
var ControlMixin = (function (Base) {
	return Base.extend({
		...
		_setControlValue: function _setControlValue(value) {
			...
			return this._validate(value, options).then(function (value) {
		...
		_validate: function _validate(value, options) {
			...
			var validator = this.getControlValidator(options);
			var validate = validator(value, options);
			return validate.then(function (value) {
				return _this3._onControlValidateSuccess(value, options);
			}, function (error) {
				return _this3._onControlValidateFail(error, value, options);
			});
		},
		_defaultControlValidator: function _defaultControlValidator(value, options, validate) {
			var promises = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];

			var values = this.getParentControlValue({ notValidated: true });
			var validateResult = _.isFunction(validate) && validate.call(this, value, values, options) || undefined;
  ...
  */
		...
		isControlWrapper: function isControlWrapper() {
