...
var index$20 = (function (Base) {
	...
	return Mixed.extend({
		...
		buildViewByKey: function buildViewByKey(key) {
			var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
		...
		buildButtonsView: function buildButtonsView() {
			...
			var view = buildViewByKey('buttonsView', { allowTextView: false, options: options });
			if (!view) {
				return;
			}
...
export { index$24 as mixins, index$12 as components, index$13 as utils };
